        ...
        <div class="row justify-content-center">
            <div class="col-md-5 col-lg-4">
                ...
                <div class="text-center mb-4">
                    ...
                    <p class="noctra-label mt-3">Sign in to your account</p>
                </div>
                ...
                <div style="background: var(--noctra-card); border: 1px solid var(--noctra-border); padding: 2rem;">
                    ...
                    {{-- Session Success --}}
                    @if(session('success'))
                        <div style="background: rgba(92,184,92,0.1); border: 1px solid rgba(92,184,92,0.3);
                                    padding: .875rem 1rem; margin-bottom: 1.5rem; font-size: 13px; color: #5cb85c;">
                            {{ session('success') }}
                        </div>
                    @endif
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <label class="d-flex align-items-center gap-2"
                                   style="font-size: 13px; color: var(--noctra-gray); cursor: pointer;">
                                <input type="checkbox"
                                       name="remember"
                    ...
                    <p class="text-center mt-4 mb-0"
                       style="font-size: 13px; color: var(--noctra-gray);">
                ...
                {{-- Demo credentials --}}
                <div style="margin-top: 1.5rem; padding: 1rem; border: 1px solid var(--noctra-border);
                            background: rgba(255,255,255,0.02); font-size: 12px; color: var(--noctra-gray);">
                    <p class="mb-1" style="letter-spacing:.06em; text-transform:uppercase; font-size:10px;">
                        Demo Credentials
                    </p>
                    <p class="mb-1">Admin: <code style="color:var(--noctra-silver)">admin@noctralab.com</code></p>
                    <p class="mb-0">Password: <code style="color:var(--noctra-silver)">password</code></p>
                </div>
